...
public class FileInfoSuperPeer extends AbstractMessage{
	...
	public String getPublicIPAdd() {
		return PublicIPAdd;
	}

	public void setPublicIPAdd(String PublicIPAdd) {
		this.PublicIPAdd = PublicIPAdd;
	}
