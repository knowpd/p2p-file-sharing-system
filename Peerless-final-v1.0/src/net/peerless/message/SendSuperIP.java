...
public class SendSuperIP extends AbstractMessage{
	...
	private List pvtIpAddrList = Collections.synchronizedList(new ArrayList());
	...
	public void setPvtIPList (List pvtIpAddrList) {
		this.pvtIpAddrList = pvtIpAddrList;
	}
	
	public List getPvtIPList () {
		return this.pvtIpAddrList;
	}
